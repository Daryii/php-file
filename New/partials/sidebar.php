<div class="dashboard_sidebar" id="dashboard_sidebar">
    ...
    <div class="dashboard_sidebar_meuns">
        ...
        <!-- class="menuActive" -->
            <li class="liMainmenu">
                <a href="./index.php"><i class="fa fa-dashboard"></i> <span class="menuText">Dashboard</span></a>
            </li>
            <li class="liMainmenu showHideSubMenu" >
                ...
                <ul class="subMenus">
                    <li><a class="sublinks" href="./product-add.php"><i class="fa fa-circle-o"></i>Add Product</a></li>
                    <li><a class="sublinks" href="./product-view.php"><i class="fa fa-circle-o"></i>View Product</a></li>
                </ul>  
            </li>
        </ul>
    </div>
